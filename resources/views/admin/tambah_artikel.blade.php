        ...
        <div class="content-wrapper">
            ...
            <div class="col-xl">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/artikel"><div class="text-muted float-end">Kembali</div></a>
                </div>
                <div class="card-body">
                    <form action="/save_artikel" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="mb-3">
                        @if (session('status'))
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                        <span class="input-group-text"><i class='bx bx-note'></i>
                        </span>
                        <input
                            autocomplete="off"
