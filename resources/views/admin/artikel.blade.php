        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <h5 class="card-header">Tabel Artikel</h5>
                    <div class="card-body">
                        <div class="demo-inline-spacing">
                            <a href="/tambah_artikel" type="button" class="btn btn-outline-primary">Tambah</a>
                            @if (session('status'))
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>{{$a->tanggal}}</td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$a->judul}}</strong></td>
                        <td>{{$a->image}}</td>
                        <td>
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="/edit_artikel/{{$a->id}}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="/delete_artikel/{{$a->id}}"
