        ...
        <div class="content-wrapper">
            ...
            <div class="col-xl">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/dokter"><div class="text-muted float-end">Kembali</div></a>
                </div>
                <div class="card-body">
                    <form action="/save_edit_dokter/{{$doc->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="mb-3">
                        @if (session('status'))
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-company">Spesialis</label>
                        <div class="input-group input-group-merge">
