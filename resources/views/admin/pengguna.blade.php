            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="demo-inline-spacing">
                        {{-- <a href="/tambah_user" type="button" class="btn btn-outline-primary">Tambah</a> --}}
                        @if (session('status'))
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="/edit_user/{{$u->id}}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="/hapus_user/{{$u->id}}"
